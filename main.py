...
#等待登录完成后的跳转
WebDriverWait(driver,120,0.5).until(lambda driver:driver.current_url == "http://zhjw.scu.edu.cn/index" or driver.current_url=="http://zhjw.scu.edu.cn/","Please check your Internet and rerun the program!")
...
def catch_course(c_type:str):
    ...
    for course in user_data["course"][c_type]:
        ...
        web_wait.until(lambda driver:driver.execute_script("return document.getElementById('ifra')==null")==False)
        time.sleep(0.1)
